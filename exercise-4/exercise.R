...
flights <- mutate(flights, gained = arr_delay - dep_delay) %>% arrange(desc(gained))
# NOTE:: the pipe operator takes the output from the first ouptut and applies into the next input
# NOTE:: all dplyr functions return a data frame!!!!
